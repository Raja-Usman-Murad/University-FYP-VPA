<%@ Page Title="" Language="C#" enableEventValidation="false" MasterPageFile="~/visistor_master.master" AutoEventWireup="true" CodeFile="visitor_add_water_app.aspx.cs" Inherits="visitor_add_water_app" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <div class="ro" style="margin-top:60px">  
            <div class="row d-flex justify-content-center align-items-center slideInLeft" style="">
                <center>
                    <h2>Add Applicaton Water</h2>
