<%@ Page Title=""  EnableEventValidation="false" Language="C#" MasterPageFile="~/SuperAdmin.master" AutoEventWireup="true" CodeFile="SuperAdmin_view_school_strenght.aspx.cs" Inherits="view_school_strenght" %>
    ...
    <div class="col-md-12 mb-3">
        <label>Search By</label>
           <asp:DropDownList class="custom-select form-control dropDownChange" ID="drpsearch" runat="server"  required>
                    ...
                    <asp:ListItem class="dropdown-item" >Strength ID</asp:ListItem>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table table-bordered table-striped mt-3 w-100 text-center"
 ...
 <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="sth_id" 
                DataNavigateUrlFormatString="SuperAdmin_detailview_school_sthrength.aspx?abc={0}" 
   ...
   <script>
       $(document).ready(function () {
           ...
           if (dropDownChange.val() == 'Strength ID') {
               query.attr('type', 'number');
               query[0].placeholder = 'Enter Only Strength ID';
           }
           dropDownChange.change(function () {
               if ($(this).val() == 'Strength ID') {
                   query.attr('type', 'number');
                   query[0].placeholder = 'Enter Only Strength ID';
