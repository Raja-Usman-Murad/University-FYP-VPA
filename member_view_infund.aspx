<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/Member_master.master" AutoEventWireup="true" CodeFile="member_view_infund.aspx.cs" Inherits="member_view_infund" %>
        ...
        Width="984px">
          <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="s_no" 
                DataNavigateUrlFormatString="member_detailview_infund.aspx?abc={0}" 
