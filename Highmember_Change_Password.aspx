<%@ Page Title="" enableEventValidation="false" Language="C#" MasterPageFile="~/Member_master.master" AutoEventWireup="true" CodeFile="Highmember_Change_Password.aspx.cs" Inherits="Secetery_Change_Password" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
        ...
        <asp:TextBox ID="txtm_id" runat="server" class="form-control" placeHolder="Member ID"  required></asp:TextBox>
