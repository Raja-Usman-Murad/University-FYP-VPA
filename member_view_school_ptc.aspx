<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/Member_master.master" AutoEventWireup="true" CodeFile="member_view_school_ptc.aspx.cs" Inherits="view_school_ptc" %>
        ...
        Width="984px">
         <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="ptc_id" 
                DataNavigateUrlFormatString="member_detailview_school_ptc.aspx?abc={0}" 
