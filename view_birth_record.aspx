<%@ Page Title="" enableEventValidation="false" Language="C#" MasterPageFile="~/Admin_master.master" AutoEventWireup="true" CodeFile="view_birth_record.aspx.cs" Inherits="view_birth_record" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table table-bordered table-striped mt-3 w-100 text-center"
        Width="984px">
            ...
            <asp:HyperLinkField DataNavigateUrlFields="b_id" 
                 DataNavigateUrlFormatString="detailview_birth_record.aspx?abc={0}"
