<%@ Page Title=""  EnableEventValidation="false" Language="C#" MasterPageFile="~/Member_master.master" AutoEventWireup="true" CodeFile="Member_view_poor_record.aspx.cs" Inherits="view_poor_record" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table table-bordered table-striped mt-3 w-100 text-center"
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="p_id" 
                DataNavigateUrlFormatString="member_detailview_poor_record.aspx?abc={0}" 
