<%@ Page Title="" enableEventValidation="false" Language="C#" MasterPageFile="~/Member_master.master" AutoEventWireup="true" CodeFile="member_view_application_watwe.aspx.cs" Inherits="member_view_application_watwe" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table table-bordered table-striped mt-3 w-100 text-center"
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="app_no" 
                DataNavigateUrlFormatString="member_detailview_application_water.aspx?abc={0}" 
