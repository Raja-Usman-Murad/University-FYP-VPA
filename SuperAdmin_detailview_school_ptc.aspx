<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.master" AutoEventWireup="true" CodeFile="SuperAdmin_detailview_school_ptc.aspx.cs" Inherits="detailview_school_ptc" %>
      ...
      <Fields>
            ...
            <asp:BoundField DataField="member_parent" HeaderText="Member Parent" />
                ...
                <div class="col-md-6 mx-auto">
                    <a href="./Superadmin_view_school_ptc.aspx" class="btn btn-secondary w-100"><i class="fa fa-hand-point-left text-dark"></i> GO BACK</a>
                </div>
            </div>	
		</center>	
	</div>
