<%@ Page Title="" Language="C#" MasterPageFile="~/Member_master.master" AutoEventWireup="true" CodeFile="HighMemberHome.aspx.cs" Inherits="HighMemberHome" %>
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <hr />
        ...
        <div class="bounceIn" style="margin-top:23px">
            <center><h2 style="border-bottom:1px solid green; display:inline-block; margin-top: 15px;text-transform:capitalize;">WELCOME TO MEMBERS</h2></center>
            <br />
            <center>
            <table>
                <tr>
                    <td><h2 style="text-transform:capitalize;" >Member Name: </td>
                    <td><h2 style="text-transform:capitalize;" ><asp:Label class="text-success" ID="lbluid" runat="server"></asp:Label></td>
                </tr>
                <tr>
                    <td><h2 style="text-transform:capitalize;" >Email: </td>
                    <td><h2 style="text-transform:;" ><asp:Label class="text-success" ID="Label1" runat="server"></asp:Label></td>

                </tr>
                <tr>
                    <td><h2 style="text-transform:capitalize;" >Position: </td>
                    <td><h2 style="text-transform:uppercase";><asp:Label class="text-success" ID="Label2" runat="server"></asp:Label></td>
