<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/SuperAdmin.master" AutoEventWireup="true" CodeFile="SuperAdmin_view_marriage_record.aspx.cs" Inherits="view_marriage_record" %>
        ...
        Width="984px">
         <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="m_id" 
                DataNavigateUrlFormatString="SuperAdmin_ detailview_marrigae_record.aspx?abc={0}" 
