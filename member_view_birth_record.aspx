<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/Member_master.master" AutoEventWireup="true" CodeFile="member_view_birth_record.aspx.cs" Inherits="member_view_birth_record" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table table-bordered table-striped mt-3 w-100 text-center"
        Width="984px">
            ...
            <asp:HyperLinkField DataNavigateUrlFields="b_id" 
                DataNavigateUrlFormatString="member_detailview_birth_record.aspx?abc={0}" 
