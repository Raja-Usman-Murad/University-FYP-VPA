<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/SuperAdmin.master" AutoEventWireup="true" CodeFile="SuperAdmin_view_infund.aspx.cs" Inherits="view_infund" %>
        ...
        Width="984px">
          <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="s_no" 
                DataNavigateUrlFormatString="SuperAdmin_detailview_infund.aspx?abc={0}" 
