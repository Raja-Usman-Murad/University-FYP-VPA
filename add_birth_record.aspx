<%@ Page Title="" Language="C#"  MasterPageFile="~/Admin_master.master"  enableEventValidation="false" AutoEventWireup="true" CodeFile="add_birth_record.aspx.cs" Inherits="add_birth_record" %>
 ...
 <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="drpgender" ErrorMessage="*" ForeColor="Red" InitialValue="Select"></asp:RequiredFieldValidator>
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
        ...
        <asp:TextBox ID="txtapplicantename" runat="server" class="form-control" placeHolder="Applicant Name" required></asp:TextBox>
    ...
    <div class="col-md-6 mb-3">
        ...
        <asp:TextBox ID="txtappplinic" runat="server" class="form-control cnicA" type="text"  required maxlength="15" placeHolder="xxxxx-xxxxxxx-x"></asp:TextBox>
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
        <asp:Label ID="Label6" runat="server" Text="Child Name" ></asp:Label>
        <asp:TextBox ID="txtchildname" runat="server" class="form-control" placeholder="Child Name" required></asp:TextBox>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>
...
<div class="form-row">
    <div class="col-md-6 mb-3">
        ...
        <asp:TextBox ID="txtmothername" runat="server" class="form-control" placeHolder="Mother Name" required></asp:TextBox>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>
    <div class="col-md-6 mb-3">
        <asp:Label ID="Label10" runat="server" Text="Mother CNIC"></asp:Label>
        <asp:TextBox ID="txtmothernic" runat="server" class="form-control cnicM" type="text"  required maxlength="15" placeHolder="xxxxx-xxxxxxx-x"></asp:TextBox>
