<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_master.master" enableEventValidation="false" AutoEventWireup="true" CodeFile="view_infund.aspx.cs" Inherits="view_infund" %>
        ...
        Width="984px">
          <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="s_no" 
                 DataNavigateUrlFormatString="detailview_infund.aspx?abc={0}" 
