<%@ Page Title="" enableEventValidation="false" Language="C#" MasterPageFile="~/Admin_master.master" AutoEventWireup="true" CodeFile="Secetery_Change_Password.aspx.cs" Inherits="Secetery_Change_Password" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
        ...
        <asp:TextBox ID="txtsid" runat="server" class="form-control" placeHolder="Secretary ID"  required></asp:TextBox>
