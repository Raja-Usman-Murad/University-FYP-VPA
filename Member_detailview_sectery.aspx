<%@ Page Title="" Language="C#" MasterPageFile="~/Member_master.master" AutoEventWireup="true" CodeFile="Member_detailview_sectery.aspx.cs" Inherits="Member_detailview_sectery" %>
		...
		<asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" class="table table-bordered table-striped mt-3 w-100 text-center"
            ...
            <asp:BoundField DataField="address" HeaderText="Address" />
                ...
                <div class="col-md-6 mx-auto">
                    <a href="./Member_view_sectery.aspx" class="btn btn-secondary w-100"><i class="fa fa-hand-point-left text-dark"></i> GO BACK</a>
                </div>
		</center>	
	</div>
</div>
