<%@ Page Title="" Language="C#" MasterPageFile="~/Member_master.master" AutoEventWireup="true" CodeFile="member_detailview_poor_record.aspx.cs" Inherits="member_detailview_poor_record" %>
		...
		<asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" class="table table-bordered table-striped mt-3 w-100 text-center"
            ...
            <asp:BoundField DataField="village" HeaderText="Village" />
                ...
                <div class="col-md-6 mx-auto">
                    <a href="./Member_view_poor_record.aspx" class="btn btn-secondary w-100"><i class="fa fa-hand-point-left text-dark"></i> GO BACK</a>
                </div>
		</center>	
	</div>
</div>
