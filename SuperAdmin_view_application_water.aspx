<%@ Page Title="" enableEventValidation="false" Language="C#"  MasterPageFile="~/SuperAdmin.master" AutoEventWireup="true" CodeFile="SuperAdmin_view_application_water.aspx.cs" Inherits="view_application_water" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table table-bordered table-striped mt-3 w-100 text-center"
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="app_no" 
                DataNavigateUrlFormatString="SuperAdmin_ detailview_application_water.aspx?abc={0}" 
