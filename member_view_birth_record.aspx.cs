...
public partial class member_view_birth_record : System.Web.UI.Page
{
    SqlConnection con;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            SqlDataAdapter ad = new SqlDataAdapter("select * from birth_records where applicante_name='" + txtsearch.Text + "'", con);
            DataSet ds = new DataSet();
            ad.Fill(ds);
            GridView1.DataSource = ds;
            GridView1.DataBind();
