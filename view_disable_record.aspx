<%@ Page Title="" Language="C#" enableEventValidation="false" MasterPageFile="~/Admin_master.master" AutoEventWireup="true" CodeFile="view_disable_record.aspx.cs" Inherits="view_disable_record" %>
        ...
        Width="984px">
         <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="dis_id" 
               DataNavigateUrlFormatString="detailview_disable_record.aspx?abc={0}"
