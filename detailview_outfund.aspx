<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_master.master" AutoEventWireup="true" CodeFile="detailview_outfund.aspx.cs" Inherits="detailview_outfund" %>
	...
	<div class="row row d-flex justify-content-center align-items-center" style="width:100%">
        ...
        <Fields>
            ...
            <asp:HyperLinkField HeaderText="Edit Record" Text="Edit" 
                ...
                DataNavigateUrlFormatString="Edit_outfund.aspx?abc={0}" />
        </Fields>
    </asp:DetailsView>
