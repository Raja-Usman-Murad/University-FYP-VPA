<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.master" AutoEventWireup="true" CodeFile="SuperAdmin_detailview_school_facilities.aspx.cs" Inherits="detailview_school_facilities" %>
		...
		<asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" class="table table-bordered table-striped mt-3 w-100 text-center"
            ...
            <asp:BoundField DataField="village_name" HeaderText="Village" />
                ...
                <div class="col-md-6 mx-auto">
                    <a href="./SuperAdmin_view_school_facilities.aspx" class="btn btn-secondary w-100"><i class="fa fa-hand-point-left text-dark"></i> GO BACK</a>
                </div>
            </div>	
		</center>	
	</div>
