<%@ Page Title="" Language="C#" MasterPageFile="~/SuperAdmin.master" AutoEventWireup="true" CodeFile="SuperAdminHome.aspx.cs" Inherits="AdminHome" %>
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <hr />
        ...
        <div class="bounceIn" style="margin-top:23px">
            <center><h2 style="border-bottom:1px solid green; display:inline-block; margin-top: 15px;text-transform:capitalize;">WELCOME TO ADMIN</h2></center>
            <br />
            <center>
            <table>
                <tr>
                    <td><h2 style="text-transform:capitalize;" >Admin Name: </td>
