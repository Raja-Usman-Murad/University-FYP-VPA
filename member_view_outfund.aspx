<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/Member_master.master" AutoEventWireup="true" CodeFile="member_view_outfund.aspx.cs" Inherits="member_view_outfund" %>
    ...
    <div class="col-md-12 mb-3">
        <label>Search By</label>
           <asp:DropDownList class="custom-select form-control dropDownChange" ID="drpsearch" runat="server"  required>
                    ...
                    <asp:ListItem class="dropdown-item" >Serial Number</asp:ListItem>
                    <asp:ListItem class="dropdown-item" >Date</asp:ListItem>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table table-bordered table-striped mt-3 w-100 text-center"
        Width="984px">
         <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="s_no" 
                DataNavigateUrlFormatString="member_detailview_outfund.aspx?abc={0}" 
   ...
   <script>
       $(document).ready(function () {
           ...
           if (dropDownChange.val() == 'Serial Number') {
               query.attr('type', 'number');
               query[0].placeholder = 'Enter Only Serial Number';
           }
