<%@ Page Title="" enableEventValidation="false" Language="C#" MasterPageFile="~/Member_master.master" AutoEventWireup="true" CodeFile="Member_view_sectery.aspx.cs" Inherits="view_sectery" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table table-bordered table-striped mt-3 w-100 text-center"
        Width="984px">
         <Columns>
            <asp:BoundField DataField="s_id" HeaderText="Secretary ID" />
            <asp:BoundField DataField="name" HeaderText="Name" />
            <asp:BoundField DataField="vc_name" HeaderText="Village Concil" />
            <asp:HyperLinkField DataNavigateUrlFields="s_id" 
                DataNavigateUrlFormatString="Member_detailview_sectery.aspx?abc={0}" 
