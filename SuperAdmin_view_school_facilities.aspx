<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/SuperAdmin.master" AutoEventWireup="true" CodeFile="SuperAdmin_view_school_facilities.aspx.cs" Inherits="view_school_facilities" %>
    ...
    <div class="col-md-12 mb-3">
        <label>Search By</label>
           <asp:DropDownList class="custom-select form-control dropDownChange" ID="drpsearch" runat="server"  required>
                    ...
                    <asp:ListItem class="dropdown-item" >Facilities ID</asp:ListItem>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table table-bordered table-striped mt-3 w-100 text-center"
        Width="984px">
         <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="f_id" 
                DataNavigateUrlFormatString="SuperAdmin_detailview_school_facilities.aspx?abc={0}" 
   ...
   <script>
       $(document).ready(function () {
           ...
           if (dropDownChange.val() == 'Facilities ID') {
               query.attr('type', 'number');
               query[0].placeholder = 'Enter Only Facilitie ID';
           }
           dropDownChange.change(function () {
               if ($(this).val() == 'Facilities ID') {
                   query.attr('type', 'number');
                   query[0].placeholder = 'Enter Only Facilities ID';
