<%@ Page Title=""  EnableEventValidation="false"  Language="C#" MasterPageFile="~/Member_master.master" AutoEventWireup="true" CodeFile="member_detailview_school_information.aspx.cs" Inherits="detailview_school_information" %>
		...
		<center style="width:75%">
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <a href="./member_view_school_information.aspx" class="btn btn-secondary w-100"><i class="fa fa-hand-point-left text-dark"></i> GO BACK</a>
                </div>
            </div>			
		</center>	
	</div>
