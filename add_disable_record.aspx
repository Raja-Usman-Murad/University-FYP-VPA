<%@ Page Title="" Language="C#" enableEventValidation="false" MasterPageFile="~/Admin_master.master" AutoEventWireup="true" CodeFile="add_disable_record.aspx.cs" Inherits="add_disable_record" %>
 ...
 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="drpvillage" ErrorMessage="*" ForeColor="Red" InitialValue="Select"></asp:RequiredFieldValidator>
  ...
  <div class="form-row">
    <div class="col-md-12 mb-3">
        <asp:Label ID="Label5" runat="server" Text="Disability Type"></asp:Label>
        <asp:TextBox ID="txtdistype" runat="server" class="form-control"   placeHolder="Disability Type"  required></asp:TextBox>
