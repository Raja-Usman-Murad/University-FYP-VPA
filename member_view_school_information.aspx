<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/Member_master.master" AutoEventWireup="true" CodeFile="member_view_school_information.aspx.cs" Inherits="view_school_information" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table table-bordered table-striped mt-3 w-100 text-center"
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="school_name"
                DataNavigateUrlFormatString="member_detailview_school_information.aspx?abc={0}" 
