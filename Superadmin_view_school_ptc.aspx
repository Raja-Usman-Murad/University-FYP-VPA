<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/SuperAdmin.master" AutoEventWireup="true" CodeFile="Superadmin_view_school_ptc.aspx.cs" Inherits="view_school_ptc" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table table-bordered table-striped mt-3 w-100 text-center"
        Width="984px">
            ...
            <asp:HyperLinkField DataNavigateUrlFields="ptc_id" 
                DataNavigateUrlFormatString="SuperAdmin_detailview_school_ptc.aspx?abc={0}" 
