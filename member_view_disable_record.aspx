<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/Member_master.master" AutoEventWireup="true" CodeFile="member_view_disable_record.aspx.cs" Inherits="member_view_disable_record" %>
    ...
    <div class="col-md-12 mb-3">
        <label>Search By</label>
           <asp:DropDownList class="custom-select form-control dropDownChange" ID="drpsearch" runat="server"  required>
                    ...
                    <asp:ListItem class="dropdown-item" >Disable ID</asp:ListItem>
                    <asp:ListItem class="dropdown-item" >Name</asp:ListItem>
                    <asp:ListItem class="dropdown-item" >Village</asp:ListItem>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table table-bordered table-striped mt-3 w-100 text-center"
        Width="984px">
         <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="dis_id" 
                DataNavigateUrlFormatString="member_detailview_disable_record.aspx?abc={0}" 
