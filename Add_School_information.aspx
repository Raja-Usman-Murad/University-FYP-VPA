<%@ Page Title="" Language="C#" enableEventValidation="false" MasterPageFile="~/Admin_master.master" AutoEventWireup="true" CodeFile="Add_School_information.aspx.cs" Inherits="Add_School_information" %>
 ...
 <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="drpvillage" ErrorMessage="*" ForeColor="Red" InitialValue="Select"></asp:RequiredFieldValidator>
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
        ...
        <asp:TextBox ID="txtschol" runat="server" class="form-control" placeHolder="School Name"  required></asp:TextBox>
