<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/Member_master.master" AutoEventWireup="true" CodeFile="member_view_death_record.aspx.cs" Inherits="member_view_death_record" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table table-bordered table-striped mt-3 w-100 text-center"
       ...
       <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="d_id" 
                DataNavigateUrlFormatString="member_detailview_death_record.aspx?abc={0}" 
                HeaderText="Detail Veiw" Text="View" />
        </Columns>
</asp:GridView>
</center>
