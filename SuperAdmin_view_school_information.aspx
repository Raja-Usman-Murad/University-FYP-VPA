<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/SuperAdmin.master" AutoEventWireup="true" CodeFile="SuperAdmin_view_school_information.aspx.cs" Inherits="view_school_information" %>
    ...
    <div class="col-md-12 mb-3">
        <label>Search By</label>
           <asp:DropDownList class="custom-select form-control dropDownChange" ID="drpsearch" runat="server"  required>
                    ...
                    <asp:ListItem class="dropdown-item" >Code</asp:ListItem>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table table-bordered table-striped mt-3 w-100 text-center"
        ...
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="school_name" 
                DataNavigateUrlFormatString="SuperAdmin_detailview_school_information.aspx?abc={0}" 
   ...
   <script>
       $(document).ready(function () {
           ...
           if (dropDownChange.val() == 'School Name') {
           ...
           dropDownChange.change(function () {
               if ($(this).val() == 'School Name') {
                   ...
                   query[0].placeholder = 'Enter School Code';
                   query.attr('type', 'text');
               } else {
                   query[0].placeholder = '';
                   query.attr('type', 'text');
