<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/SuperAdmin.master" AutoEventWireup="true" CodeFile="SuperAdmin_view_disable_record.aspx.cs" Inherits="view_disable_record" %>
        ...
        Width="984px">
         <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="dis_id" 
                DataNavigateUrlFormatString="SuperAdmin_ detailview_disable_record.aspx?abc={0}" 
