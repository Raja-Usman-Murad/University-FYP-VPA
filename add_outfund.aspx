<%@ Page Title="" Language="C#" enableEventValidation="false" MasterPageFile="~/Admin_master.master" AutoEventWireup="true" CodeFile="add_outfund.aspx.cs" Inherits="add_outfund" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
        ...
        <asp:TextBox ID="txtserialno" runat="server" class="form-control" placeHolder="Serial No" type="number" required></asp:TextBox>
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
        <asp:Label ID="Label5" runat="server" Text="Expendicture All"></asp:Label>
        <asp:TextBox ID="txtexpall" runat="server" class="form-control" placeHolder="Expendicture All"  required></asp:TextBox>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>
