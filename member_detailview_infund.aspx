<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/Member_master.master" AutoEventWireup="true" CodeFile="member_detailview_infund.aspx.cs" Inherits="member_detailview_infund" %>
		...
		<asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" class="table table-bordered table-striped mt-3 w-100 text-center"
            ...
            <asp:BoundField DataField="date" HeaderText="Date" />
                ...
                <div class="col-md-6 mx-auto">
                    <a href="./member_view_infund.aspx" class="btn btn-secondary w-100"><i class="fa fa-hand-point-left text-dark"></i> GO BACK</a>
                </div>
            </div>	
		</center>	
	</div>
