<%@ Page Title="" Language="C#" MasterPageFile="~/Member_master.master" AutoEventWireup="true" CodeFile="member_detailview_birth_record.aspx.cs" Inherits="member_detailview_birth_record" %>
	...
	<div class="row row d-flex justify-content-center align-items-center" style="width:100%">
		...
		<asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" class="table table-bordered table-striped mt-3 w-100 text-center"
            ...
            <asp:BoundField DataField="village" HeaderText="Village Name" />
                    ...
                    <a href="./member_view_birth_record.aspx" class="btn btn-secondary w-100"><i class="fa fa-hand-point-left text-dark"></i> GO BACK</a>
                </div>
		</center>	
	</div>
</div>
